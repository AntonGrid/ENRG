...
|---|---|---|---|---|
| **Sourceful Energy** `sourceful.energy` | 3 products **live**: Energy Gateway, App, **Zap** (P1 meter, RJ12 → utility smart meter) | Closest physical analogue: home/distributed energy hardware + production data on Solana. Tagline: "Slash Your Energy Bills. Stabilize the Grid." | Same physical layer, same chain, same buyer (asset owner / operator) | We sell a *provable* reading (SE050 key, ≥2 staked oracles, slashing, on-chain audit trail) — they sell a device plus app UX |
