...
- **Резолюция (2026-08-17):** ✅ legacy v1 удалён из git (D-1); v1/v2 перенесены в `firmware/legacy/` (папка в `.gitignore`, вне поставки). Приватный ключ заредэктирован в архивной копии.
